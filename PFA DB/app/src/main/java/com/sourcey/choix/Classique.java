...
import com.sourcey.choix.MyListeEtudiantAdapterM;
...
public class Classique extends ListActivity implements  FetchEtudiantInfosM.AsyncEtudiantData{
    private ListView mlistViewEtudiant;
    private  MyListeEtudiantAdapterM mListViewEtudiantAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mListViewEtudiantAdapter = new MyListeEtudiantAdapterM(new ArrayList<Etudiant>(), this);
