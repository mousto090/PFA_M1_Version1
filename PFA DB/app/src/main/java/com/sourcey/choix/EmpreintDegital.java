...
import com.sourcey.auto.Empreinte;
import com.sourcey.choix.MyListeEtudiantEmpAdapterM;
...
public class EmpreintDegital extends ListActivity implements  FetchEtudiantInfosM.AsyncEtudiantData{
    private ListView mlistViewEtudiant;
    private  MyListeEtudiantEmpAdapterM mListViewEtudiantAdapter;
    private FetchEtudiantInfosM mFetchEtudiantInfosM ;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mListViewEtudiantAdapter = new MyListeEtudiantEmpAdapterM(new ArrayList<Etudiant>(), this);


        mFetchEtudiantInfosM = new FetchEtudiantInfosM();
        mFetchEtudiantInfosM.delegateEtudiantData = this;
        mFetchEtudiantInfosM.execute(loginName,classe);
        ...
        mlistViewEtudiant.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(EmpreintDegital.this, Empreinte.class);
                intent.putExtra("login", message);
                EmpreintDegital.this.startActivity(intent);
            }
        });
...
//        mListViewEtudiantAdapter = new MyListeEtudiantAdapter(Arrays.asList(result),this);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(EmpreintDegital.this, LoginActivity.class);
        EmpreintDegital.this.startActivity(intent);
    }
}
